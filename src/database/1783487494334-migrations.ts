...
export class Migrations1783487494334 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "meal-plans" ADD CONSTRAINT "FK_67fb1c6d77c56bc9a5fb1c116f6" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "meal-plans" DROP CONSTRAINT "FK_67fb1c6d77c56bc9a5fb1c116f6"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fd3144fdf12d164d0ef8679e2f"`,
    );
